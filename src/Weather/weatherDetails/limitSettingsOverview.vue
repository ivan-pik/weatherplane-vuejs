<template>
	<div class="limitSettingsOverview">
		...
		<div class="limitSettingsOverview__params-wrapper">
			...
			<div class="limitSettingsOverview__params-wrapper-fader">
			</div>

			<div class="limitSettingsOverview__params-wrapper-scroller">
				...
				<div class="limitSettingsOverview__param limitSettingsOverview__param--windSpeed">
					...
					<p class="limitSettingsOverview__value">{{settingsMaxWindSpeed}} ms</p>
				</div>
				...
				<div class="limitSettingsOverview__param limitSettingsOverview__param--crossWind">
					...
					<p class="limitSettingsOverview__value">{{settingsMaxCrossWindSpeed}} ms</p>
				</div>
				...
				<div class="limitSettingsOverview__param limitSettingsOverview__param--temperature">
					...
					<p class="limitSettingsOverview__value">{{settingsMinTemperature}} - {{settingsMaxTemperature}}&deg;C</p>
				</div>

<template>
	<div class="placesList__itemWrapper">
...
<script>
	export default {
		...
		methods: {
			openPlaceSettings () {
				this.$router.push({ path: `/${this.place._userID}/${this.place.placeSlug}/settings` });
			},
			activateArrangeMode () {
				this.contextMenuOpen=false;
				this.$emit('enterArrangingMode');
			},
